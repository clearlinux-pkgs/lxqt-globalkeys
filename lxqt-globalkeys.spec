...
Version  : 1.0.1
Release  : 15
URL      : https://github.com/lxqt/lxqt-globalkeys/releases/download/1.0.1/lxqt-globalkeys-1.0.1.tar.xz
Source0  : https://github.com/lxqt/lxqt-globalkeys/releases/download/1.0.1/lxqt-globalkeys-1.0.1.tar.xz
Source1  : https://github.com/lxqt/lxqt-globalkeys/releases/download/1.0.1/lxqt-globalkeys-1.0.1.tar.xz.asc
...
%prep
%setup -q -n lxqt-globalkeys-1.0.1
cd %{_builddir}/lxqt-globalkeys-1.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641854332
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/lxqt-globalkeys-1.0.1/LICENSE %{buildroot}/usr/share/package-licenses/lxqt-globalkeys/7fab4cd4eb7f499d60fe183607f046484acd6e2d
pushd clr-build
%make_install
popd
...
/usr/lib64/liblxqt-globalkeys-ui.so.1.0.0
/usr/lib64/liblxqt-globalkeys.so.1
/usr/lib64/liblxqt-globalkeys.so.1.0.0
